...
int main() 
{
    ...
    std::vector<int> all_ids2 = get_ids(URL2_with_ids, { {"scout_report_template_id", "71"}, {"user_api_token", TOKEN} });
    std::vector<int> all_ids3 = get_ids(URL3_with_ids, { {"user_api_token", TOKEN} });
    ...
    std::vector<nlohmann::json> jsonData2 = get_data_thousandths(thousandth_ids2, URL2_with_data, { {"scout_report_template_id", "71"}, {"limit", "1000"}, {"user_api_token", TOKEN} });
    std::vector<nlohmann::json> jsonData3 = get_data_thousandths(thousandth_ids3, URL3_with_data, { {"limit", "1000"}, {"user_api_token", TOKEN} });
